...
export const Evaluations = () => {
  ...
  // Debug: monitorear cambios en selectedStudentId
  useEffect(() => {
    console.log('🔍 selectedStudentId cambió:', selectedStudentId);
  }, [selectedStudentId]);
    ...
    try {
      ...
      if (studentsResponse && typeof studentsResponse === 'object' && 'success' in studentsResponse && studentsResponse.success && 'data' in studentsResponse) {
        ...
        studentsToEvaluateData = students.map(student => ({
          ...
          cover_letter: student.cover_letter || ''
        }));
  ...
  const handleViewProfile = (student: StudentToEvaluate) => {
    ...
    console.log('🔍 ID del estudiante a establecer:', student.student_id);
  ...
  if (loading) {
    ...
    <Box sx={{ flexGrow: 1, p: 3 }}>
      ...
      <StudentProfileModal
        ...
        error={profileError}
        projectTitle="Proyecto Completado"
