...
def run_migrations():
    ...
    commands = [
        ...
        ("python manage.py migrate", "Ejecutando migraciones"),
    ]
...
def create_superuser():
    ...
    create_command = '''python manage.py shell -c "
...
def migrate_apps():
    ...
    if not run_command("python migrate_all_apps.py", "Migrando apps del backend original"):
        return False
...
def collect_static():
    ...
    return run_command("python manage.py collectstatic --noinput", "Recolectando archivos estáticos")
...
def check_installation():
    ...
    checks = [
        ("Verificando Django", "python manage.py check"),
        ("Verificando base de datos", "python manage.py dbshell -c 'SELECT 1;'"),
    ]
...
def main():
    ...
    steps = [
        ...
        ("Migrando apps del backend original", migrate_apps),
