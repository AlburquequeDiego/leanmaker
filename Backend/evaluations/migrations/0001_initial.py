    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pendiente'), ('completed', 'Completada'), ('flagged', 'Marcada'), ('deleted', 'Eliminada')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('achievement_type', models.CharField(choices=[('certification', 'Certificación'), ('award', 'Premio'), ('competition', 'Competencia'), ('publication', 'Publicación'), ('patent', 'Patente'), ('other', 'Otro')], default='other', max_length=20)),
