#!/usr/bin/env python
"""
Script para actualizar los niveles de API de todos los estudiantes
"""
import os
import sys
import django
...
def update_api_levels():
    """Actualiza los niveles de API de todos los estudiantes"""
    ...
    for estudiante in estudiantes:
        ...
        if nuevo_api_level > estudiante.api_level:
            ...
            estudiante.api_level = nuevo_api_level
            estudiante.save(update_fields=['api_level'])
