...
urlpatterns = [
    ...
    path('admin/<int:student_id>/suspend/', views.admin_suspend_student, name='admin_suspend_student'),
    path('admin/<int:student_id>/activate/', views.admin_activate_student, name='admin_activate_student'),
    path('admin/<int:student_id>/block/', views.admin_block_student, name='admin_block_student'),
] 